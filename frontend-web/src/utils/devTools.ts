...
class DevToolsManager {
  ...
  constructor() {
    ...
    this.state.isEnabled = process.env.NODE_ENV === 'development' || 
                          localStorage.getItem('kinect_dev_tools') === 'true';
  ...
  getCurrentDate(): Date {
    return this.state.timeTravel.enabled 
      ? this.state.timeTravel.currentDate 
      : new Date();
  }
