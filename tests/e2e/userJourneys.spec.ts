...
test.describe('Contact Management', () => {
  ...
  test('should create a new contact', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="contact-name"]').filter({ hasText: 'John Doe' })).toBeVisible();
  });
  ...
  test('should edit an existing contact', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="contact-notes"]')).toContainText('Updated notes from E2E test');
  });
  ...
  test('should log communication with contact', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="communication-log"]')).toContainText('Had a great conversation');
  });
...
test.describe('Contact Lists', () => {
  ...
  test('should create a new contact list', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="contact-list-item"]').filter({ hasText: 'Test List' })).toBeVisible();
  });
...
test.describe('Search and Filtering', () => {
  ...
  test('should search contacts by name', async ({ page }) => {
    ...
    await expect(visibleContacts.first().locator('[data-testid="contact-name"]')).toContainText('Emma');
  });
...
test.describe('Reminder System', () => {
  ...
  test('should update reminder status after logging contact', async ({ page }) => {
    ...
    const overdueContact = page.locator('[data-testid="contact-card"]')
    ...
    const updatedContact = page.locator('[data-testid="contact-name"]').filter({ hasText: contactName || '' });
    const parentCard = updatedContact.locator('..');
    
    await expect(parentCard.locator('[data-testid="reminder-badge"][data-status="recent"]')).toBeVisible();
  });
});
